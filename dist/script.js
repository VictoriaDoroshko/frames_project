...
/* harmony default export */ __webpack_exports__["default"] = (accordion); // --- Second method ---
...
/* harmony default export */ __webpack_exports__["default"] = (scrolling); //Pure JS scrolling
...
var showMoreStyles = function showMoreStyles(trigger, wrapper) {
  var btn = document.querySelector(trigger); //------First way
  // btn.addEventListener('click', function() {
  ...
  btn.addEventListener('click', function () {
    Object(_services_requests__WEBPACK_IMPORTED_MODULE_3__["getResource"])('assets/db.json') //-->link to file
    .then(function (res) {
